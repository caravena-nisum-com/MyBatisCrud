package com.caravena.mybatisdemo;
...
import com.caravena.mybatisdemo.service.UserService;
...
public class UserServiceTest {
	 ...
	 * user.setPassword("secret"); user.setFirstName("TestFirstName");
	 ...
	 * user.setLastName("TestLastName"+timestamp); userService.updateUser(user);
